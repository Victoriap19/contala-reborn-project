...
export default function Register() {
  ...
  return <div className="min-h-screen flex items-center justify-center px-4 bg-slate-50">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl p-8 md:p-10 shadow-xl bg-contala-brown">
          ...
          {selectedPlan && userType !== "creador" && <div className="bg-contala-pink/20 p-3 rounded-lg mb-6">
          ...
          <div className="flex flex-col space-y-3 mb-6">
            <Button type="button" variant="outline" className="bg-white text-contala-green border-none hover:bg-gray-100 flex items-center justify-center gap-2" onClick={() => handleSocialLogin("Google")}>
            ...
            <Button type="button" variant="outline" className="bg-[#1877F2] text-white border-none hover:bg-[#1877F2]/90 flex items-center justify-center gap-2" onClick={() => handleSocialLogin("Facebook")}>
              <Facebook size={24} />
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input placeholder="Nombre de usuario" className="bg-contala-cream text-contala-brown placeholder:text-contala-green/50 border-none pl-10" />
                      </FormControl>
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input {...field} type="email" placeholder="tu@email.com" className="bg-contala-cream text-contala-green placeholder:text-contala-green/50 border-none pl-10" disabled={!!searchParams.get("email") || !!sessionStorage.getItem("userEmail")} />
                      </FormControl>
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input {...field} type={showPassword ? "text" : "password"} placeholder="Contraseña" className="bg-contala-cream text-contala-green placeholder:text-contala-green/50 border-none pr-10" />
                      </FormControl>
                      <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-contala-green" onClick={() => setShowPassword(!showPassword)} aria-label={showPassword ? "Ocultar contraseña" : "Mostrar contraseña"}>
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input {...field} type={showConfirmPassword ? "text" : "password"} placeholder="Confirmar contraseña" className="bg-contala-cream text-contala-green placeholder:text-contala-green/50 border-none pr-10" />
                      </FormControl>
                      <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-contala-green" onClick={() => setShowConfirmPassword(!showConfirmPassword)} aria-label={showConfirmPassword ? "Ocultar contraseña" : "Mostrar contraseña"}>
              ...
              {userType === "creador" && <div className="p-3 bg-contala-green/80 rounded-lg border border-contala-cream/20">
              ...
              field
                    ...
                    <FormControl>
                      <Checkbox checked={field.value} onCheckedChange={field.onChange} className="data-[state=checked]:bg-contala-pink data-[state=checked]:border-contala-pink" />
                    </FormControl>
              ...
              <Button type="submit" className="w-full bg-contala-pink hover:bg-white text-contala-green font-bold py-3 rounded-lg transition-colors mt-6">
