  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-contala-green mb-6">
      ...
      <section className="py-16 bg-contala-cream/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-contala-green text-center mb-12">
            ¿Cómo funciona?
          </h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="w-16 h-16 bg-contala-pink/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                <span className="text-2xl font-bold text-contala-green">1</span>
              </div>
              <h3 className="text-xl font-bold text-contala-green text-center mb-4">Regístrate y crea tu perfil</h3>
              <p className="text-contala-green/80 text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="w-16 h-16 bg-contala-pink/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                <span className="text-2xl font-bold text-contala-green">2</span>
              </div>
              <h3 className="text-xl font-bold text-contala-green text-center mb-4">Conecta con marcas</h3>
              <p className="text-contala-green/80 text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="w-16 h-16 bg-contala-pink/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                <span className="text-2xl font-bold text-contala-green">3</span>
              </div>
              <h3 className="text-xl font-bold text-contala-green text-center mb-4">Cobra por tu trabajo</h3>
              <p className="text-contala-green/80 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="bg-contala-pink/20 p-4 rounded-full h-16 w-16 flex items-center justify-center shrink-0 mx-auto md:mx-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-contala-green"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-contala-green mb-3 text-center md:text-left">Pagos seguros</h3>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="bg-contala-pink/20 p-4 rounded-full h-16 w-16 flex items-center justify-center shrink-0 mx-auto md:mx-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-contala-green"><path d="M17 18a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2"></path><rect width="18" height="12" x="3" y="4" rx="2"></rect></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-contala-green mb-3 text-center md:text-left">Exposición</h3>
                <p className="text-contala-green/80">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="bg-contala-pink/20 p-4 rounded-full h-16 w-16 flex items-center justify-center shrink-0 mx-auto md:mx-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-contala-green"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="M12 11h4"></path><path d="M12 16h4"></path><path d="M8 11h.01"></path><path d="M8 16h.01"></path></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-contala-green mb-3 text-center md:text-left">Sin negociaciones</h3>
                <p className="text-contala-green/80">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="bg-contala-pink/20 p-4 rounded-full h-16 w-16 flex items-center justify-center shrink-0 mx-auto md:mx-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-contala-green"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"></path></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-contala-green mb-3 text-center md:text-left">Tú eres el dueño</h3>
                <p className="text-contala-green/80">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h4 className="font-bold text-contala-green">Sofía Martínez</h4>
                  <p className="text-sm text-contala-green/70">@sofi.lifestyle</p>
                </div>
              </div>
              <p className="text-contala-green/80 italic">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-contala-pink/20 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-bold text-contala-green">Mateo Gómez</h4>
                  <p className="text-sm text-contala-green/70">@mateofitness</p>
                </div>
              </div>
              <p className="text-contala-green/80 italic">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-contala-green/10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-contala-pink/20 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-bold text-contala-green">Lucía Torres</h4>
                  <p className="text-sm text-contala-green/70">@luciateaches</p>
                </div>
              </div>
              <p className="text-contala-green/80 italic">
      ...
      <section className="py-16 bg-contala-pink/10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-contala-green mb-6">
              Comisiones transparentes
            </h2>
            <p className="text-xl text-contala-green/80 mb-8">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="border border-contala-green/10 rounded-lg p-6">
              <h3 className="text-xl font-bold text-contala-green mb-2">¿Cómo recibo mi pago?</h3>
              <p className="text-contala-green/80">
            ...
            <div className="border border-contala-green/10 rounded-lg p-6">
              <h3 className="text-xl font-bold text-contala-green mb-2">¿Qué pasa si la marca no está satisfecha?</h3>
              <p className="text-contala-green/80">
            ...
            <div className="border border-contala-green/10 rounded-lg p-6">
              <h3 className="text-xl font-bold text-contala-green mb-2">¿Puedo proponer mis propios proyectos?</h3>
              <p className="text-contala-green/80">
            ...
            <div className="border border-contala-green/10 rounded-lg p-6">
              <h3 className="text-xl font-bold text-contala-green mb-2">¿Hay un mínimo de seguidores requerido?</h3>
              <p className="text-contala-green/80">
