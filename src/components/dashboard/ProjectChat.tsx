...
export function ProjectChat({ 
  ...
  const handleSendMessage = () => {
    ...
    toast.success("Mensaje enviado. Se ha notificado al creador por email.");
  };
  ...
  return (
    <div className="flex flex-col h-[500px] rounded-lg shadow-md border bg-gray-50">
      {/* Chat Header */}
      ...
      {/* Chat Messages */}
      <ScrollArea className="flex-1 p-3 bg-gray-50" ref={scrollAreaRef}>
