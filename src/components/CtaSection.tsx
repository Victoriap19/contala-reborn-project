  ...
  return (
    <section className="py-24 px-4 md:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="bg-gradient-to-br from-contala-navy to-contala-navy/90 rounded-2xl p-8 md:p-16 shadow-xl overflow-hidden relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full">
            ...
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-contala-navy/20 rounded-full blur-3xl transform -translate-x-1/3 translate-y-1/3"></div>
          </div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                className="bg-white text-contala-navy hover:bg-white/90 h-14 px-8 text-base rounded-md"
                asChild
              >
            ...
            <div className="mt-10">
              <div className="flex flex-wrap gap-6 justify-center items-center">
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-contala-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
